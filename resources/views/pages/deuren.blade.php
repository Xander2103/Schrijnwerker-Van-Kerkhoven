...
@php
    $locale ??= 'nl';
    $heroPreload = 'assets/client/images/deuren/hero-deuren.webp';
@endphp
...
@include('partials.subservices', ['coreKey' => 'deuren'])

@include('partials.related-projects', ['cards' => \App\Support\Projects::forService('deuren', $locale)])
