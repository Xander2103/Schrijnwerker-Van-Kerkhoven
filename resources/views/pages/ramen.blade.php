...
@section('page_title', __('pages.ramen_title'))
@section('page_description', __('pages.ramen_desc'))
...
>
    <div class="client-container">
        <div class="page-hero-content">
            ...
            <span class="section-eyebrow">{{ __('pages.ramen_eyebrow') }}</span>
            <h1 class="page-hero-title">{{ __('pages.ramen_heading') }}</h1>
            <p class="page-hero-intro">{{ __('pages.ramen_intro') }}</p>
        </div>
    </div>
</section>
